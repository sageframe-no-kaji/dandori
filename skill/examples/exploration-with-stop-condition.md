...
- Create: `agent-tasks/findings/2026-05-09-anthropic-export-shape.md` (the report)

**Required Changes**

This task produces a report, not code. The report should cover:
...
- [ ] Report file exists at `agent-tasks/findings/2026-05-09-anthropic-export-shape.md`.
...
test -f agent-tasks/findings/2026-05-09-anthropic-export-shape.md
grep -c "^## " agent-tasks/findings/2026-05-09-anthropic-export-shape.md   # should print 6 or more

# Confirm no code was modified
git status src/ tests/   # should show no changes

# Sanity-check redaction (no obvious unredacted text)
grep -E '"text":\s*"[^[]' agent-tasks/findings/2026-05-09-anthropic-export-shape.md   # should print nothing
```

**Do Not**

- Do not modify the parser. Schema decisions belong to the practitioner.
...
```
findings: anthropic export shape inspection

Inspect ~/exports/anthropic-2026-04.json against the current AnthropicParser
schema. Report at agent-tasks/findings/2026-05-09-anthropic-export-shape.md.
